...
<div data-role="page" id="camiseta1">
	...
	<div data-role="content" data-theme="a">
		<form name="camiseta" action="calca" method="post">
			<p>
				<center>
			...
			<p><input type="submit" value="Selecionar" name="selecionar" style = "color:black; background-color:white; font-size:12px; font-weight:bold; width:100; height:45; font-family:verdana;"></p>
			<p><a href="modelos.php#calca?variavel=1" data-role="button">Look</a></p>
